        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-2xl font-bold">Hope Foundation</span>
            </div>
            <p className="text-gray-300 mb-4">
              Creating lasting change in communities worldwide through education, 
            ...
            <div className="flex space-x-4">
              ...
              <button className="w-8 h-8 bg-blue-400 rounded-full flex items-center justify-center hover:bg-blue-500">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/fundraise" className="text-gray-300 hover:text-white transition-colors">Fundraise</a></li>
              <li><a href="/partner" className="text-gray-300 hover:text-white transition-colors">Partner With Us</a></li>
              <li><a href="/corporate" className="text-gray-300 hover:text-white transition-colors">Corporate Giving</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to our newsletter for the latest updates on our work and impact.
            </p>
            <form className="space-y-3">
              <input
                type="email"
                placeholder="Your email address"
                className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-charity-primary focus:border-transparent"
              />
